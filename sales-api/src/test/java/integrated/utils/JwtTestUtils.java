...
public class JwtTestUtils {
    ...
    public static String generateToken(UUID subject, String... roles) {
        return generateTokenWithAudience(subject, "dealership", roles);
    }

    public static String generateTokenWithAudience(UUID subject, String audience, String... roles) {
        try {
            var now = Instant.now();
