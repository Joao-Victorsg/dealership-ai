...
<#assign xKeycloakify={
    ...
    "themeType": "login",
    "themeName": "aurelio-keycloakify",
    "keycloakifyVersion": "11.15.3",
    "themeVersion": "0.0.0",
    "resourcesPath": ""
}>
...
<base href="${xKeycloakify.resourcesPath}/dist/">
    <meta charset="UTF-8">
    <link rel="icon" type="image/svg+xml" href="${xKeycloakify.resourcesPath}/dist/favicon.svg">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>keycloakify-theme</title>
    <script type="module" crossorigin="" src="${xKeycloakify.resourcesPath}/dist/assets/index-B3Ybkn0v.js"></script>
  </head>
  <body>
    <div id="root"></div>
